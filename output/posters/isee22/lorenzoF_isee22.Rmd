...
```{r, echo=FALSE}
knitr::include_graphics("images/study_design.svg")
```
...
|:---:|:---:|:---:|:---:|:---:|:---:|
| OP pesticides | DEP | Serum metabolome | Serotonin | 0.052 | Exposure to pesticides linked to changes in the serotonergic system [@slotkin2008developmental; @judge2016mechanism; @sarrouilhe2021exposome] |
| Phenols | TRCS | Serum metabolome | Serotonin | -0.055 | Association between personal care product ingredients and serotonin [@houten2016changes] |
